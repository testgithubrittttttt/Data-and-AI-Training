...
| **Evaluation Metrics**     | Accuracy, Precision, Recall, MSE, F1-score                  | Silhouette score, Davies–Bouldin Index, visualization         | Cumulative reward, average reward, convergence rate             |
